...
filename = ['ZZZ_TPR_clus_',num2str(K),'.csv'];
...
filename = ['ZZZ_EST_proportions_',num2str(K),'.csv'];
...
filename = ['ZZZ_BETA_EST_num_clus_',num2str(K),'.csv'];
