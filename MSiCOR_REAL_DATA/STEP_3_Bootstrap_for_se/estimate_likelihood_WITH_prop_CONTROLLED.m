...
function log_likelihood = estimate_likelihood_WITH_prop_CONTROLLED(matrices, initial_dists, sequences, proportions)
    ...
    for k = 1:K
        ...
        for l = 1:L
            ...
            temps(l) = proportions(l)*initial_dists{l}(sequences{k}(1)) * prod(matrices{l}(m));
