...
function log_likelihood = estimate_likelihood_WITH_propMAT_CONTROLLED(matrices, initial_dists, sequences, membership_prob)
    ...
    for k = 1:K
        ...
        for l = 1:L
            ...
            temps(l) = membership_prob(k,l)*initial_dists{l}(sequences{k}(1)) * prod(matrices{l}(m));
