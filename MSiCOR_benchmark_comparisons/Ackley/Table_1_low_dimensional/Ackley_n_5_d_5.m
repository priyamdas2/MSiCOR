...
lb_here = (-5)*ones(M-1,n);
ub_here = (5)*ones(M-1,n);


fun = @(x) sum((-20*exp(-0.2*sqrt(1/(M-1)*sum(((M-1)*x(1:(M-1),:).*(ub_here-lb_here)+lb_here).^2)))-exp(1/(M-1)*sum(cos(2*pi*((M-1)*x(1:(M-1),:).*(ub_here-lb_here)+lb_here))))+20+exp(1)));

lb_here_ga = (-5)*ones(1,(M-1));
ub_here_ga = (5)*ones(1,(M-1));


fun_ga_ackley = @(xxx) sum((-20*exp(-0.2*sqrt(1/(M-1)*sum(((M-1)*xxx((M-1)*(1-1)+1:(M-1)*1).*(ub_here_ga-lb_here_ga)+lb_here_ga).^2))) ...
    -exp(1/(M-1)*sum(cos(2*pi*((M-1)*xxx((M-1)*(1-1)+1:(M-1)*1).*(ub_here_ga-lb_here_ga)+lb_here_ga))))+20+exp(1))) + ...
    sum((-20*exp(-0.2*sqrt(1/(M-1)*sum(((M-1)*xxx((M-1)*(2-1)+1:(M-1)*2).*(ub_here_ga-lb_here_ga)+lb_here_ga).^2))) ...
    -exp(1/(M-1)*sum(cos(2*pi*((M-1)*xxx((M-1)*(2-1)+1:(M-1)*2).*(ub_here_ga-lb_here_ga)+lb_here_ga))))+20+exp(1))) + ...
    sum((-20*exp(-0.2*sqrt(1/(M-1)*sum(((M-1)*xxx((M-1)*(3-1)+1:(M-1)*3).*(ub_here_ga-lb_here_ga)+lb_here_ga).^2))) ...
    -exp(1/(M-1)*sum(cos(2*pi*((M-1)*xxx((M-1)*(3-1)+1:(M-1)*3).*(ub_here_ga-lb_here_ga)+lb_here_ga))))+20+exp(1))) + ...
    sum((-20*exp(-0.2*sqrt(1/(M-1)*sum(((M-1)*xxx((M-1)*(4-1)+1:(M-1)*4).*(ub_here_ga-lb_here_ga)+lb_here_ga).^2))) ...
    -exp(1/(M-1)*sum(cos(2*pi*((M-1)*xxx((M-1)*(4-1)+1:(M-1)*4).*(ub_here_ga-lb_here_ga)+lb_here_ga))))+20+exp(1))) + ...
    sum((-20*exp(-0.2*sqrt(1/(M-1)*sum(((M-1)*xxx((M-1)*(5-1)+1:(M-1)*5).*(ub_here_ga-lb_here_ga)+lb_here_ga).^2))) ...
    -exp(1/(M-1)*sum(cos(2*pi*((M-1)*xxx((M-1)*(5-1)+1:(M-1)*5).*(ub_here_ga-lb_here_ga)+lb_here_ga))))+20+exp(1)));% + ...
%     sum((-20*exp(-0.2*sqrt(1/(M-1)*sum(((M-1)*xxx((M-1)*(6-1)+1:(M-1)*6).*(ub_here_ga-lb_here_ga)+lb_here_ga).^2))) ...
%     -exp(1/(M-1)*sum(cos(2*pi*((M-1)*xxx((M-1)*(6-1)+1:(M-1)*6).*(ub_here_ga-lb_here_ga)+lb_here_ga))))+20+exp(1))) + ...
%     sum((-20*exp(-0.2*sqrt(1/(M-1)*sum(((M-1)*xxx((M-1)*(7-1)+1:(M-1)*7).*(ub_here_ga-lb_here_ga)+lb_here_ga).^2))) ...
%     -exp(1/(M-1)*sum(cos(2*pi*((M-1)*xxx((M-1)*(7-1)+1:(M-1)*7).*(ub_here_ga-lb_here_ga)+lb_here_ga))))+20+exp(1))) + ...
%     sum((-20*exp(-0.2*sqrt(1/(M-1)*sum(((M-1)*xxx((M-1)*(8-1)+1:(M-1)*8).*(ub_here_ga-lb_here_ga)+lb_here_ga).^2))) ...
%     -exp(1/(M-1)*sum(cos(2*pi*((M-1)*xxx((M-1)*(8-1)+1:(M-1)*8).*(ub_here_ga-lb_here_ga)+lb_here_ga))))+20+exp(1))) + ...
%     sum((-20*exp(-0.2*sqrt(1/(M-1)*sum(((M-1)*xxx((M-1)*(9-1)+1:(M-1)*9).*(ub_here_ga-lb_here_ga)+lb_here_ga).^2))) ...
%     -exp(1/(M-1)*sum(cos(2*pi*((M-1)*xxx((M-1)*(9-1)+1:(M-1)*9).*(ub_here_ga-lb_here_ga)+lb_here_ga))))+20+exp(1))) + ...
%     sum((-20*exp(-0.2*sqrt(1/(M-1)*sum(((M-1)*xxx((M-1)*(10-1)+1:(M-1)*10).*(ub_here_ga-lb_here_ga)+lb_here_ga).^2))) ...
%     -exp(1/(M-1)*sum(cos(2*pi*((M-1)*xxx((M-1)*(10-1)+1:(M-1)*10).*(ub_here_ga-lb_here_ga)+lb_here_ga))))+20+exp(1)));
...
for jjj = 1: sim_reps
    ...
    [jjj, min(das_algo_values(1:jjj)), min(fmincon_values_ip(1:jjj)), min(fmincon_values_sqp(1:jjj)), min(ga_values(1:(jjj-1)))]
    ...
    x_ga = ga(fun_ga_ackley,size(X0,2),A,b,Aeq,beq,lb,ub,[],options);
    ga_times(jjj) = toc;
    ga_values(jjj) = fun_ga_ackley(x_ga);
...
mean(das_algo_times)
[jjj, min(das_algo_values), min(fmincon_values_ip), min(fmincon_values_sqp), min(ga_values)]

filename = ['Ackley_output_MSiCOR_IP_SQP_GA_d_', num2str(M-1),'_n_' ,num2str(n),'.xls'];
